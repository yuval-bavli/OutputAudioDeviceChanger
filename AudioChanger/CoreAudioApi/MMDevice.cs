...
*/
/* 
   This file was altered from the original source code. 
   Changes:
   - It doesn't depend on application settings
   - Description property was added (returns device description).
*/
    ...
    internal class MMDevice
    {
        ...
        public string Description
        {
            get
            {
                ...
                var nameGuid = PKEY.PKEY_Device_DeviceDesc;
